...
# COMPLETAR - INICIO
comparar_nombre_y_edad = ((persona_01 == persona_02) and (edad_01 == edad_02 or (edad_01 != edad_02)))
# COMPLETAR - FIN
...
if superficie_de_campo_01 < superficie_de_campo_02:
    ...
    else: comparar_superficie = False
# COMPLETAR - FIN
...
if bananas < (naranjas/2):
    if (naranjas/2) < 2*manzanas and (2*manzanas <= peras*peras):
